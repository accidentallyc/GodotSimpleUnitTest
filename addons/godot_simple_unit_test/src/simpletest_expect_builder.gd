...
func __size_base(n, description: String = &"", equal_text = &"", comparator = null ):
    var collection_size = SimpleTest_Utils.size(value)
...
func size(n, description: String = &""):
    return __size_base(n, description, &"have size", LambdaOperations.equals)
    
func size_gt(n, description: String = &""):
    return __size_base(n, description, &"have size greater than", LambdaOperations.gt)	
    
func size_gte(n, description: String = &""):
    return __size_base(n, description, &"have size greater than or equal to", LambdaOperations.gte)
    
func size_lt(n, description: String = &""):
    return __size_base(n, description, &"have size lesser than", LambdaOperations.lt)	
    
func size_lte(n, description: String = &""):
    return __size_base(n, description,  &"have size lesser than or equal to", LambdaOperations.lte)
