...
func __size_base(n, description: String = &"", equal_text = &"", comparator = null ):
	var collection_size = GD__.size(value)
...
func size(n, description: String = &""):
	return __size_base(n, description, &"have size", GD__.eq)
	
func size_gt(n, description: String = &""):
	return __size_base(n, description, &"have size greater than", GD__.gt)	
	
func size_gte(n, description: String = &""):
	return __size_base(n, description, &"have size greater than or equal to", GD__.gte)
	
func size_lt(n, description: String = &""):
	return __size_base(n, description, &"have size lesser than", GD__.lt)	
	
func size_lte(n, description: String = &""):
	return __size_base(n, description,  &"have size lesser than or equal to", GD__.lte)
